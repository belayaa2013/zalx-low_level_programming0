 ...
 * @e_ident: A pointer to an array containing the ELF magic numbers.
  */
void print_magic(unsigned char *ptr)
{
	int index;
 ...
 * @ptr: A pointer to an array containing the ELF class.
 */
void print_entry(unsigned long int e_entry, unsigned char *ptr)
{
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	check_elf(header->ptr);
	printf("ELF Header:\n");
	print_magic(header->ptr);
	print_class(header->ptr);
	print_data(header->ptr);
	print_version(header->ptr);
	print_osabi(header->ptr);
	print_abi(header->ptr);
	print_type(header->type, header->ptr);
	print_entry(header->e_entry, header->ptr);
